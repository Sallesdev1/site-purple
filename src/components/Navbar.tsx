...
export default function Navbar() {
    ...
    const navLinks = [
        { name: 'Inicio', href: '/#' },
        { name: 'Quem somos', href: '/#features' },
        { name: 'O que entregamos', href: '/#pricing' },
        { name: 'Contato', href: '/#faq' },
    ];
    ...
    return (
        ...
        >
            <div className='max-w-6xl mx-auto flex items-center justify-between bg-black/50 backdrop-blur-md border border-white/4 rounded-2xl p-3'>
                <a href='/#'>
                    <img src='public/images/logo-purple.svg' alt="logo" className="h-15" />
                </a>
                ...
                <div className='hidden md:flex items-center gap-3'>
                    ...
                    <PrimaryButton className='max-sm:text-xs hidden sm:inline-block'>Começar agora</PrimaryButton>
                </div>
            ...
            <div className={`flex flex-col items-center justify-center gap-6 text-lg font-medium fixed inset-0 bg-black/40 backdrop-blur-md z-50 transition-all duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
                ...
                <PrimaryButton onClick={() => setIsOpen(false)}>Começar agora</PrimaryButton>
